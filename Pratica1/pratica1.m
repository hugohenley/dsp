function varargout = pratica1(varargin) %Código pratica1 MATLAB para pratica1.fig
% INÍCIO do código de inicialização da pratica1
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @pratica1_OpeningFcn, ...
                   'gui_OutputFcn',  @pratica1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% FIM do código de inicialização da pratica1


function pratica1_OpeningFcn(hObject, eventdata, handles, varargin)
handles.output = hObject; %Saída padrão para pratica1
guidata(hObject, handles);%Atualiza estruturas de handles

function varargout = pratica1_OutputFcn(hObject, eventdata, handles) %Saída desta função é retornada para linha de commando
